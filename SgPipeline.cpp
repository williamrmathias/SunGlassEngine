...
namespace SunGlassEngine {
	...
	void SgPipeline::enableAlphaBlending(PipelineConfigInfo& configInfo) {
		...
		configInfo.colorBlendAttachment.dstColorBlendFactor = VK_BLEND_FACTOR_ONE_MINUS_CONSTANT_ALPHA;
